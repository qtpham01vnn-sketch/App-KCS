  ...
  getRange: (maGach, loaiLo) => {
    ...
    if (gach.includes("30X60")) {
      if (loai.includes("XƯƠNG")) {
        startMod = 21; endMod = 47;
      } else if (loai.includes("MEN")) {
        startMod = 21; endMod = 52;
        isEvenAllowed = true;
      }
    } else if (gach.includes("40X80")) {
      if (loai.includes("XƯƠNG")) {
        startMod = 21; endMod = 51;
      } else if (loai.includes("MEN")) {
        startMod = 21; endMod = 55;
      }
    } else if (gach.includes("50X50") || gach.includes("60X60") || gach.includes("80X80")) {
      startMod = 21; endMod = 51;
      isEvenAllowed = true;
    }
